...
public class ExcelWriter {
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
        ...
        // Create a Sheet
        Sheet sheet = workbook.createSheet("View");
        ...
        dataCellFont.setFontHeightInPoints((short) 7);

        // Cell Style for formatting Date
        CellStyle dateCellStyle = workbook.createCellStyle();
        dateCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("dd-MM-yyyy"));
        dateCellStyle.setFont(dataCellFont);
        dateCellStyle.setFillBackgroundColor(IndexedColors.RED.getIndex());
